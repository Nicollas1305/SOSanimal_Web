        ...
        <div class="wrapper">
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="View/cadastrarCliente.jsp"><i class="fas fa-user"></i> Cadastrar Cliente</a></li>
                    <li><a href="View/cadastrarAnimal.jsp"><i class="fas fa-paw"></i> Cadastrar Animal</a></li>
                    <li><a href="View/exibirClientes.jsp"><i class="fas fa-address-card"></i> Exibir Clientes</a></li>
                    <li><a href="View/exibirAnimais.jsp"><i class="fas fa-paw"></i> Exibir Animais</a></li>
            ...
            <div class="main_content">
                <div class="header">SOS Animal</div>  
                <div class="info">
